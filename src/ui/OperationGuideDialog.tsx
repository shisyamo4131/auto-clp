      ...
      <section className="operation-guide" aria-label="3Dビューワーの操作方法">
        ...
        <dl>
          ...
          <div>
            <dt>積荷を移動・回転</dt>
            <dd>
              マウスなどの細かなポインターでは、積荷を左ドラッグして移動できます。スナップがONなら、50 mm以内の積荷側面またはコンテナ内壁へフィットします。的形のボタンで側面・内壁スナップだけをON／OFFでき、床・積荷上面への高さ合わせは常に有効です。配置済み積荷を選んで3Dにフォーカスすると、矢印キーで現在の視点に沿って1 mmずつ調整できます。X／Zボタンは90°回転し、天地無用の積荷はX軸回転できません。
            </dd>
          </div>
          <div>
            <dt>取り消し・やり直し</dt>
