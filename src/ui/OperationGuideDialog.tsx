      ...
      <section className="operation-guide" aria-label="3Dビューワーの操作方法">
        ...
        <dl>
          ...
          <div>
            <dt>積荷を移動・回転</dt>
            <dd>
              マウスなどの細かなポインターでは、積荷を左ドラッグして移動できます。スナップがONなら、50 mm以内の積荷側面またはコンテナ内壁へ最大2面までフィットし、吸着中は75 mmまで保持します。的形のボタンで側面・内壁スナップだけをON／OFFできます。床に置く場合は床面、段積みする場合は載せたい積荷の上面へカーソルを合わせてください。配置済み積荷を選んで3Dにフォーカスすると、矢印キーで現在の視点に沿って1 mmずつ調整できます。X／Zボタンは90°回転し、天地無用の積荷はX軸回転できません。
            </dd>
          </div>
          <div>
            <dt>取り消し・やり直し</dt>
