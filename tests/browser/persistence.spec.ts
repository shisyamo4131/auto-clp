...
test("opens the operation guide without changing CLP, history, or scene and restores focus and scroll", async ({
  ...
  for (const copy of [
    ...
    "3D上でホイールを回して拡大・縮小し",
    "立方体のボタンで荷室全体を表示します。",
    "四方向の内向き矢印ボタンで、荷室外の積荷を選択中コンテナの近くへ再整列します。現在の視点と縮尺は変えず",
    "積荷を左ドラッグして移動できます。",
    "スナップがONなら、50 mm以内の積荷側面またはコンテナ内壁へ最大2面までフィットし、吸着中は75 mmまで保持します。",
    "的形のボタンで側面・内壁スナップだけをON／OFFでき",
    "段積みする場合は載せたい積荷の上面へカーソルを合わせてください。",
    "矢印キーで現在の視点に沿って1 mmずつ調整できます。",
