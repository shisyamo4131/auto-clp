...
- Planned: Project参照・interaction generationによるstale判定、非永続preview、cutoff/no-complete-plan表示、確認付き一括適用とUndo。
