...
| CSV積荷一括作成・置換 | [仕様](specification.md)、[データ契約](data-model.md)、[ADR 0034](decisions/0034-cargo-csv-template-and-replacement-import.md)、[AC-07](acceptance.md#ac-07-cargo-csv-template-and-atomic-replacement)、[ロードマップ](roadmaps/auto-clp.md) | Excel向け固定CSV、30件新規作成上限、全行検証、件数確認、一回のUndo/Redo、既存31〜1,000件互換、Excel往復 |
