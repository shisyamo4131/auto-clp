...
| コンテナ未登録時の導線 | [仕様](specification.md)、[ADR 0040](decisions/0040-empty-container-guidance-and-csv-import-gate.md)、[受入](acceptance.md) | viewport中央の登録案内、既存コンテナ追加dialog、CSVインポート利用条件、JSON互換 |
...
| 公開配信 | [仕様](specification.md)、[ADR 0038](decisions/0038-github-pages-technical-preview-and-future-hosting.md)、[運用](operations.md)、[ロードマップ](roadmaps/auto-clp.md) | GitHub Pages、Actions、base path、公開確認、停止・将来Firebase再評価 |
