...
正規単位と値域、Phase 1の開口部モデル、積荷別許可向き、支持と荷重の扱いはADR 0005〜0008、軸別固定隙間の意味はADR 0011で確定した。完全な搬入経路、方向ラベル、部分支持、積荷別上載荷重、重心、軸重、床荷重、荷崩れ、固縛、動荷重が代表ケースで必要になった場合は、後継ADRで範囲を拡張する。
