...
| 物理制約の判定 | 20 | 7 | In progress | コンテナ包含、正体積AABB重なり、隙間込み5面境界・床例外、非支持ペア距離、矩形開口の2Y・1Z寸法と許可向き抽出を純粋geometryと境界テストで実装。経路状態、支持例外の合成、理由コード、集約、段積み、耐荷重、UI表示は未実装 |
