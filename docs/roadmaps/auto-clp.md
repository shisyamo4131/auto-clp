...
1. `HUT-01` 修正後の派生床突き抜けfixtureを人間が再試用し、床貫通だけを直せば成立する上段支持不足・pair隙間を連鎖表示せず、独立する不適合を保持することを確認する。
2. 正式fixture、評価者区分、狭幅補足文、自然なTab順、確認後focus、WebGL非対応fallbackを観察する。
