...
1. [AC-06](../acceptance.md#ac-06-cargo-center-of-gravity-reference-markers)と[ADR 0033](../decisions/0033-equal-borderless-center-markers.md)の匿名合成データで、同径10 CSS px・白い外枠なし、完全一致・近接時の黄前面表示、偏り・画面外・積荷内部・積荷背面、camera操作、物理判定lampとの非混同、凡例理解、狭幅を人間が差分確認する。
