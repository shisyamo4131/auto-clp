...
| 積荷・コンテナ入力モデル | 12 | 12 | Complete | CLP・隙間・積荷・コンテナの入力、編集、明示削除、Drawer内コンテナ管理、mm・kg変換、許可向き、原子的検証、アクセシビリティ、狭幅表示を実装し検証 |
...
1. 単一支持グループの3D drag preview・取消・dropと、支持不可専用理由を内蔵ブラウザで差分確認する。
