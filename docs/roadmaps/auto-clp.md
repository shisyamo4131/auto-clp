...
1. 人間再試用で仕様0.16.0のdrag集中表示は期待どおりと確認済み。仕様0.17.1の固定回転toolbarについて、操作荷B（小）でX不可・Z可、操作荷D（大）でX/Z可、軸付き回転iconの90度差、明暗による可否、2回連続回転時のbutton位置不変をChromeで確認する。
