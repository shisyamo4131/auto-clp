...
| 3D表示と手動配置 | 25 | 1 | In progress | ADR 0010でコンテナ局所座標と最小角アンカーを確定。描画、選択、移動、回転、カメラ、取り消し、ブラウザ試験は未実装 |
...
| 3D表示と手動配置 | [ADR 0001](../decisions/0001-local-first-web-architecture.md)、[ADR 0002](../decisions/0002-cuboid-model.md)、[ADR 0010](../decisions/0010-container-coordinate-and-placement-anchor.md) | 座標契約を確定。Project→scene投影、選択、配置操作は未実装 | 座標契約の読み取り専用調査・テスト設計・独立レビュー |
