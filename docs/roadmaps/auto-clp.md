...
3. 仕様1.2.1・ADR 0027の3D欄外tab、`整数 mm`だけの寸法annotationと外向き矢印、icon-only物理判定lampを差分中心の人間試用で確認する。仕様1.2.0で合格済みの操作は自動回帰へ戻し、Schema 0.1.0と進捗98%は人間確認完了まで維持する。
